            ...
            <div className="row justify-content-center">
                ...
                >
                  <div className="fetures-thumb-three">
                    <Link href="/services-details">
                      <img src="/assets/img/images/features_img01.jpg" alt="" />
                    </Link>
                  </div>
              ...
              <div className="col-xl-4 col-md-6">
                ...
                >
                  <div className="fetures-thumb-three">
                    <Link href="/services-details">
                      <img src="/assets/img/images/features_img02.jpg" alt="" />
                    </Link>
                  </div>
                  <div className="fetures-content-three">
                    <div className="fetures-icon-three">
              ...
              <div className="col-xl-4 col-md-6">
                ...
                >
                  <div className="fetures-thumb-three">
                    <Link href="/services-details">
                      <img src="/assets/img/images/features_img03.jpg" alt="" />
                    </Link>
                  </div>
                  <div className="fetures-content-three">
                    <div className="fetures-icon-three">
                    ...
                    <h4 className="title">
                      <Link href="/services-details">Quality Maintenance</Link>
                    </h4>
                    <p>
                      There are many variations of passages of Lorem Ipsum
                      available, but the majority have suffered.
