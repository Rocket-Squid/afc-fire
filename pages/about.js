            ...
            <div className="row">
              <div className="col-xl-3 col-md-6">
                <div className="work-item">
                  ...
                  <div className="work-content">
                    <h2 className="title">Plan for Fire Safety</h2>
                    <p>
              ...
              <div className="col-xl-3 col-md-6">
                <div className="work-item">
                  ...
                  <div className="work-content">
                    <h2 className="title">Enjoy Fire Safety</h2>
                    <p>
                      Suffered alteration in some a form, by injected humour, or
                      randomised word
                    </p>
              ...
              <div className="col-lg-6">
                <div className="history-content">
                  <div className="section-title mb-20">
                    <span className="sub-title">Our Fire Safety History</span>
                    <h2 className="title">
                      Fire Safety when an unknown printer took to make type book
                    </h2>
                  </div>
                  <p>
                    There are many variations of passages of Lorem Ipsum
